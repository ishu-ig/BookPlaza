...
import { createPublisher, getPublisher } from "../../Redux/ActionCreators/PublisherActionCreators";

const checklist = [
  { dot: "bg-primary", title: "Publisher Name", body: "Use the publisher's official, unique name."     },
  { dot: "bg-success", title: "Contact Details", body: "Add address, email, and phone if available."   },
  { dot: "bg-warning", title: "Set Status",      body: "Active publishers appear in product listings." },
];
        ...
        <div className="page-heading">
          <div className="page-heading-copy">
            ...
            <div>
              ...
              <h1 className="h3 mb-1">Add Publisher</h1>
              <p className="text-muted mb-0">Create a new publisher entry.</p>
            </div>
          </div>
            ...
            <div className="panel">
              <div className="panel-header">
                <div>
                  ...
                  <p className="text-muted mb-0">Fill in the details to create a new publisher.</p>
                </div>
              </div>
              ...
              <div className="row g-3">
                ...
                <div className="col-md-12">
                  <label className="form-label" htmlFor="logo">
                    Logo <span className="text-muted fw-normal">(optional)</span>
                  </label>
              ...
              <div className="d-flex flex-wrap justify-content-end gap-2 mt-4">
                ...
                <button className="btn btn-primary" type="button" onClick={postSubmit}>
                  <i className="bi bi-check-circle" aria-hidden="true"></i> Create Publisher
                </button>
              </div>
            </div>
          </div>
