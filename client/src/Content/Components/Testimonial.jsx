    ...
    <>
      <style>{`
        ...
        .testi-card:hover {
          ...
          border-color: #D9CCC0;
          box-shadow: 0 16px 40px rgba(120,80,30,0.09);
        }
        ...
        .testi-name {
          ...
          color: #1A1208; margin-bottom: 2px;
        }

        .testi-stars {
          font-size: 13px; color: #D97706; letter-spacing: 1px;
        }

        .testi-message {
          font-size: 14px; color: #7C6A52;
          line-height: 1.78; font-style: italic; flex: 1;
        }

        .testi-quote {
          font-size: 44px; color: #EDE3D5;
        ...
        .testi-swiper .swiper-pagination-bullet {
          background: #D9CEC4; opacity: 1; width: 8px; height: 8px;
        }
        .testi-swiper .swiper-pagination-bullet-active {
          background: #D97706; width: 24px; border-radius: 4px;
        }
        ...
        .stat-card:hover {
          border-color: #D9CCC0;
          box-shadow: 0 8px 24px rgba(120,80,30,0.07);
        }

        .stat-value {
          font-family: 'Syne', sans-serif;
          font-size: 26px; font-weight: 800;
          color: #D97706; letter-spacing: -0.02em; margin-bottom: 4px;
        }

        .stat-label {
          font-size: 12px; font-weight: 300; color: #9A8472;
        ...
        .testi-cta h2 {
          ...
          color: #FFFAF5; margin-bottom: 10px; letter-spacing: -0.02em;
        }
      ...
      <section className="testi-section">
        <div className="container">
          ...
          <div className="text-center mb-5">
            <div className="testi-eyebrow" style={{ justifyContent: "center" }}>Social proof</div>
          ...
          {/* CTA */}
          <div className="testi-cta d-flex flex-column flex-md-row align-items-center justify-content-between gap-4">
            <div>
